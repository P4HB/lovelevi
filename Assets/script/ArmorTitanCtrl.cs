...
//     public float burstSpeed = 1000.0f;           // 폭주 시 속도
...
//     private bool isBursting = false; // 현재 버스트 중인지 확인
...
//                         if (agent.CalculatePath(playerTr.position, path) && path.status == NavMeshPathStatus.PathComplete)
//                         {
...
//                             if (!isBursting)
//                             {
//                                 anim.SetBool(hashWalk, agent.velocity.sqrMagnitude > 0.01f);
//                                 anim.SetBool(hashRun, false); // 혹시 켜져 있을 수도 있으니 꺼줌
//                             }
//                         }
//                         else
//                         {
...
//         {
//             isBursting = true;
//             anim.SetBool(hashRun, true);  // Run 애니메이션 ON
//             anim.SetBool(hashWalk, false);
...
//             isBursting = false;
//             anim.SetBool(hashRun, false); // Run 애니메이션 OFF
//         }
//     }
// }
...
//     // 기타 필요한 함수들 (피격 처리 등)은 기존 스크립트처럼 여기에 추가하면 됩니다.
